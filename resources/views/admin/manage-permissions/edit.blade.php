    ...
    <div>
        <div class="rounded overflow-hidden shadow bg-white w-full mb-[1rem]">
            <div class="px-6 py-2 border-b border-light-grey flex justify-between">
                <div class="font-bold text-xl">Edit Permissions</div>
                <div>
                    <a href="{{route('permissions.index')}}" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-xs px-4 py-2 mb-2">Back</a>
                </div>
            </div>
        </div>
        <div>
                ...
                <div class="grid md:grid-cols-3 gap-[1rem] md:gap-[2rem]">
                    <div class="h-fit md:col-span-2 shadow px-[3rem] py-[1.5rem] bg-[#66666622] space-y-[1.5rem]">
                        <div class="grid lg:grid-cols-12">
                            <label for="permission_name" class="lg:col-span-2 text-gray-900 pt-[.5rem] mb-0 text-right">Name:</label>
                            <div class="lg:col-span-1"></div>
                            <div class="lg:col-span-9">
                                <input type="text" name="permission_name" value="{{name_deformat($data->name)}}" id="permission_name" class="h-[39px] px-[9px] py-[12px] text-[13px] text-[#555555] border border-[#eeeeee] w-full" required autofocus>
                            </div>
                        </div>
                        <div class="grid lg:grid-cols-12">
