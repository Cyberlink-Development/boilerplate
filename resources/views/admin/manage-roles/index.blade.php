    ...
    <div>
        <div class="rounded overflow-hidden shadow bg-white w-full mb-[1rem]">
            <div class="px-6 py-2 border-b border-light-grey flex justify-between">
                <div class="font-bold text-xl">Roles</div>
                @can('roles_create')
                    <div>
                        <a href="{{route('roles.create')}}" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-xs px-4 py-2 mb-2">Create</a>
                    </div>
                @endcan
            </div>
        </div>
                                        ...
                                        <tr class="whitespace-nowrap text-start">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">
                                                    @can('roles_show')
                                                        <a href="{{route('roles.show',$row->id)}}" class="hover:underline">{{name_deformat($row->name)}}</a>
                                                    @else
