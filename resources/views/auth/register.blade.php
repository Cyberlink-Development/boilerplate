    ...
    <section class="flex items-center justify-center h-screen w-full p-[1.5rem]">
        <div class="space-y-[2rem] flex flex-col items-center">
            ...
            <div class="bg-[#66666622] flex flex-col">
                <h1 class="p-[.8rem] text-center text-[1.5rem] font-bold">User Register</h1>
                <form action="{{route('register.store')}}" method="post">
                    ...
                    <div class="flex flex-col shadow px-[3rem] py-[1.5rem] bg-[#66666622] space-y-[1.5rem]">
                        <div class="grid lg:grid-cols-12 bg-white p-[.5rem]">
                            <label for="f_name" class="lg:col-span-2 text-gray-900 pt-[.5rem] mb-0 lg:text-right">Full Name:</label>
                            <div class="lg:col-span-1"></div>
                            <div class="lg:col-span-9">
                                <input type="text" name="f_name" id="f_name" class="h-[39px] px-[9px] py-[12px] text-[13px] text-[#555555] border border-[#eeeeee] w-full" required autofocus>
                            </div>
                        </div>
                        <div class="grid lg:grid-cols-12 bg-white p-[.5rem]">
                            ...
                            <div class="lg:col-span-1"></div>
                            <div class="lg:col-span-9">
                                <input type="email" name="email" id="email" class="h-[39px] px-[9px] py-[12px] text-[13px] text-[#555555] border border-[#eeeeee] w-full" required>
                            </div>
                        </div>
                        <div class="grid lg:grid-cols-12 bg-white p-[.5rem]">
                        ...
                        <div class="grid lg:grid-cols-12 bg-white p-[.5rem]">
                            <label for="password_confirmation" class="lg:col-span-2 text-gray-900 pt-[.5rem] mb-0 lg:text-right">Confirm Password:</label>
                            <div class="lg:col-span-1"></div>
                            <div class="lg:col-span-9">
                                <input type="password" name="password_confirmation" id="password_confirmation" class="h-[39px] px-[9px] py-[12px] text-[13px] text-[#555555] border border-[#eeeeee] w-full" required>
                            </div>
                        </div>
